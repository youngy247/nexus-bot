...
app.post('/', async (req, res) => {
    try {
        ...
        const response = await openai.createCompletion({
            ...
            Adam Young is a young 21 years old Software engineer who just graduated from the Full Stack Track course at IO Academy bootcamp and is now on the job hunt to get a job as Junior Software engineer.
